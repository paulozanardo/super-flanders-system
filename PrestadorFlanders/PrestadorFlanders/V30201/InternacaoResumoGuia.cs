...
{
    internal class InternacaoResumoGuia
    {
        public bool AlterarInternacaoGuia(ctm_internacaoResumoGuia item, bool retorno)
        {
            ...
            ctm_internacaoResumoGuia itemConvertido = item;
